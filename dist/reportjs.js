...
($traceurRuntime.createClass)(Renderer, {renderTo: function(element, options) {
    ...
    if (options.layout.type === 'table') {
      ...
      var graphRenderer = new GraphRenderer(options.layout.datasets, options.layout.labels, options.layout.graphType, options.layout.height),
