...
describe('OutputHtml', function() {
    it('render', function() {
        let output = new OutputHtml(),
        ...
        expect(output.getHtml(result)).toEqual('<table><tr><td></td><td>d11</td><td>d12</td></tr><tr><td>d21</td><td>10</td><td></td></tr><tr><td>d22</td><td>8</td><td>5</td></tr></table>');
    });
});
