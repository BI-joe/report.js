...
export class Processor {
    ...
    process(options) {
        ...
        switch (options.layout.type) {
            ...
            case 'graph':
                let graphProcessor = new GraphProcessor(options.layout.measures, options.layout.datasets, options.layout.labels, options.layout.graphType, options.layout.height, options.layout.width);
