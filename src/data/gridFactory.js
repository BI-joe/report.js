...
export class GridFactory {
    ...
    buildFromJson(gridData) {
        ...
        gridData.dimensions.forEach((dimension, index) => {
        ...
        dimensionPositions.forEach((index, dimensionId) => {
            gridData.dimensionValues[index].forEach((dimensionValue, dimensionValueIndex) => {
